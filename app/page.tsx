                ...
                {selectedAruaru && (
                  <>
                    ...
                    <div className="mb-2 rounded-2xl bg-white/70 p-4 text-[#4e433d] ring-1 ring-[#f1e4da]">
                      <p className="mb-1 text-sm font-semibold text-[#9a7d69]">カード用コピー</p>
                      <p className="text-left text-lg font-bold not-italic text-[#4e433d] sm:text-xl">{cardCopy.replace(/\n/g, " ")}</p>
                    </div>
