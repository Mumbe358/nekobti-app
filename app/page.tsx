...
診断してみてね`
  ...
  const generateShareImage = async () => {
    ...
    try {
      ...
      ctx.font = "700 48px 'Noto Sans JP'";
      ...
      copyLines.forEach((line) => {
        ctx.font = "900 88px 'Noto Sans JP'";
      ...
      ctx.fillText(`${result.mainType}タイプ`, width / 2, imgY + imgSize + 20);

      // ブランド
      ctx.fillStyle = "#9a7d69";
      ctx.font = "700 42px 'Noto Sans JP'";
      ctx.fillText("©ねこびーてぃあい", width / 2, imgY + imgSize + 70);
