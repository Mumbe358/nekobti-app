...
const aruaruMap: Record<CatType, AruaruSet[]> = {
  "しずか哲学ねこ": [
    { text: "夜になると急に活動し始める。昼は静かなのに、暗くなった部屋のすみでじっと何か考えてる顔をしている。呼ぶと少し間をおいてから来る。", quote: "いま考えてるにゃ。あとで行くにゃ。" },
    { text: "窓の外を長い時間見ている。鳥も虫もいないのに、なぜか真剣な顔でずっと一点を見つめている。話しかけると、ゆっくりだけ振り向く。", quote: "まだ見てるにゃ。少し待つにゃ。" },
    { text: "みんなが騒いでいる時は少し離れた場所にいる。でも静かになった瞬間だけ、すっと近くに来て隣に座る。落ち着いた空気を選んで動くタイプ。", quote: "いまなら行くにゃ。ここでいいにゃ。" },
    { text: "お気に入りの場所がいつも同じ。しかも部屋の真ん中じゃなく、少し端の落ち着く位置を選ぶ。誰かが座ると別の静かな場所へ移動する。", quote: "ここが落ち着くにゃ。静かにするにゃ。" },
  ],
  "よりそい守りねこ": [
    { text: "誰かが横になると、いつの間にかその近くに来ている。ぴったりくっつくわけじゃないのに、手を伸ばせば触れられる距離に必ずいる。", quote: "ここにいるにゃ。そばにいるにゃ。" },
    { text: "元気がなさそうな人のところにだけ寄っていく。他の人には行かないのに、その人の足元や横に静かに座り続ける。", quote: "大丈夫にゃ。ここにいるにゃ。" },
    { text: "寝ている人の足元に丸くなる。邪魔にならない絶妙な位置で落ち着いていて、起きてもすぐには離れない。", quote: "ここで見るにゃ。まだいるにゃ。" },
    { text: "怒られても完全には離れない。少し距離を取って座り直して、それでも同じ部屋には残っている。", quote: "離れないにゃ。気にしてるにゃ。" },
  ],
  "規律番ねこ": [
    { text: "ごはんの時間が少しでも遅れると、決まった場所で待ち始める。鳴くタイミングまで毎日ほぼ同じで、時計を見ているみたいに正確。", quote: "時間にゃ。もう分かってるにゃ。" },
    { text: "トイレや寝床の位置が変わるとすぐ気づく。いつもの位置に戻るまで落ち着かず、変わったものにはなかなか近づかない。", quote: "違うにゃ。元に戻すにゃ。" },
    { text: "部屋を移動するルートがいつも同じ。椅子の横を通って棚の前で止まって、そのあと窓際に行く流れまで毎回ほとんど変わらない。", quote: "ここ通るにゃ。決まってるにゃ。" },
    { text: "新しい物が置かれるとすぐには触らない。遠くから見て、安全そうだと分かってからやっと近づいて匂いを確認する。", quote: "まだ早いにゃ。確認するにゃ。" },
  ],
  "戦略きれものねこ": [
    { text: "高い場所に登る時、無駄な試行をほとんどしない。一度だけ周りを見て、踏み台にする場所を決めたらそのまま最短で成功する。", quote: "そこ行けるにゃ。もう見えたにゃ。" },
    { text: "ドアや引き出しの仕組みを観察している。人が開けるのを何度か見たあと、自分でも前足で同じ場所を触り始める。", quote: "こうするにゃ。分かったにゃ。" },
    { text: "おもちゃをすぐには追わない。まず相手の動きや落ちる場所を見て、狙いを定めてから一番いいタイミングで飛びつく。", quote: "まだ行かないにゃ。今にするにゃ。" },
    { text: "他の猫が騒いでいても、少し離れた場所から様子を見ている。危なくないか確認してから、自分に必要な時だけ動く。", quote: "先に見るにゃ。それから行くにゃ。" },
  ],
  "無口クラフトねこ": [
    { text: "段ボールや袋を見ると、とりあえず中に入る。ただ入るだけじゃなく、中で向きを変えたり前足で押したりして、自分の落ち着く形に整えている。", quote: "これ使うにゃ。ちょうどいいにゃ。" },
    { text: "ヒモや細いおもちゃだけやたら得意。他のおもちゃには見向きもしないのに、それだけは何回投げても正確に仕留める。", quote: "それ貸すにゃ。やってみるにゃ。" },
    { text: "壊れたおもちゃも捨てずに遊ぶ。取れた部品や紐の端だけで、元より面白そうな遊び方を見つけている。", quote: "まだいけるにゃ。直して使うにゃ。" },
    { text: "静かだと思ったら、家具のすき間や見慣れない場所を前足でずっと触っている。何があるか、どう動くかを確かめている感じがある。", quote: "ちょっと触るにゃ。分かるまでやるにゃ。" },
  ],
  "ふわアートねこ": [
    { text: "カーテン越しの光や床の反射をじっと見ている。何もないのに、急に前足を出して追いかけ始めて、満足すると静かに座り直す。", quote: "これきれいにゃ。ちょっと追うにゃ。" },
    { text: "寝る場所を見た目じゃなく触り心地で選ぶ。ふわふわの毛布、やわらかい服、少しあたたかいクッションにだけ長くいる。", quote: "ここいいにゃ。落ち着くにゃ。" },
    { text: "急に走り出したと思ったら、次の瞬間には窓辺で止まっている。予定がある感じじゃなく、その時の気分で全部決めている動き。", quote: "いま行くにゃ。もういいにゃ。" },
    { text: "小さな音への反応が早い。袋の音や引き出しの音にすぐ耳が向いて、少しだけ近づいて様子を見る。", quote: "いまの何にゃ？気になるにゃ。" },
  ],
  "ゆめふわロマンねこ": [
    { text: "何もない壁や空中をじっと見ている。呼んでもすぐには反応しないのに、二回目でゆっくり振り向いてくる。自分の世界に入っている時間が長い。", quote: "いま見てたにゃ。あとで行くにゃ。" },
    { text: "お気に入りの場所に入ると長時間ほとんど動かない。丸くなっているわけでもなく、ぼんやり起きたまま静かに過ごしている。", quote: "ここがいいにゃ。そのままでいいにゃ。" },
    { text: "甘えてくる時は急に距離が近い。でも満足すると、こちらが追う前にすっと離れていく。近づき方も離れ方も独特。", quote: "ちょっと行くにゃ。やっぱ戻るにゃ。" },
    { text: "他の猫や人と完全には離れないけど、ぴったりもくっつかない。少し離れたところで同じ空間にいたがる。", quote: "そこにいるにゃ。ここでいいにゃ。" },
  ],
  "ひらめき遊びねこ": [
    { text: "普通のおもちゃでも、みんなと違う遊び方を始める。転がすより止めたり、追うよりひっくり返したりして仕組みを見ている感じがある。", quote: "これ違うにゃ。こうするにゃ。" },
    { text: "同じ動きを何回も繰り返す。前足で押す、止まる、また押すを延々と続けていて、本人だけずっと真剣。", quote: "もう一回にゃ。試すにゃ。" },
    { text: "他の猫が興味を示さない物にだけ反応する。コードの影、箱の角、転がらない部品みたいな微妙なものに夢中になる。", quote: "これ面白いにゃ。続けるにゃ。" },
    { text: "おもちゃを壊して中身を見たがる。遊ぶより、どうできているか確かめているような動きになる。", quote: "中見るにゃ。知りたいにゃ。" },
  ],
  "突撃アクティブねこ": [
    { text: "閉まりかけたドアを見ると、そのまま突っ込んでいく。間に合うか考える前に動いていて、止めても勢いが勝つ。", quote: "いけるにゃ！そのまま行くにゃ！" },
    { text: "高い場所からのジャンプにためらいがない。下をちょっと見たらすぐ飛んで、着地してから何事もなかった顔をしている。", quote: "飛ぶにゃ！あとで考えるにゃ！" },
    { text: "危なそうな場所ほど先に行く。棚のすき間、ドアの向こう、知らない部屋に一番最初に入るのはだいたいこのタイプ。", quote: "先行くにゃ！大丈夫にゃ！" },
    { text: "急にスイッチが入って部屋を全力で走り回る。一直線に一周して、満足したら急に止まって毛づくろいを始める。", quote: "いまにゃ！止まらないにゃ！" },
  ],
  "きらきらパーティーねこ": [
    { text: "人が集まっている場所に必ず入ってくる。気づいたら一番触られやすい真ん中の位置を取っていて、そのまま場の中心にいる。", quote: "こっち楽しいにゃ！混ざるにゃ！" },
    { text: "笑い声やにぎやかな音がすると、別の部屋からでもすぐ来る。何が起きているか分からなくても、その空気だけで参加しにくる。", quote: "なんかあるにゃ！行くにゃ！" },
    { text: "誰かが遊んでいると、そのすぐ近くに座る。自分も完全に参加しているつもりで、ずっと楽しそうに見ている。", quote: "それやるにゃ！一緒にいるにゃ！" },
    { text: "静かな場所に長くいない。音や動きのある方へ自然に流れていって、気づいたらまた人のいる場所に戻っている。", quote: "いまにゃ！そっち行くにゃ！" },
  ],
  "わくわく自由ねこ": [
    { text: "新しいおもちゃや箱を見ると真っ先に飛びつく。少し遊んだだけで満足して、次の瞬間には別の物に興味が移っている。", quote: "それいいにゃ！次いくにゃ！" },
    { text: "人が移動するとすぐ後をついていく。でも途中で別の音や物に気を取られて、目的地まで行かずに寄り道する。", quote: "そっち行くにゃ！やっぱこっちにゃ！" },
    { text: "遊び始めると一気にテンションが上がる。全力で楽しんでいたのに、数分後には急に落ち着いて別の場所で座っている。", quote: "楽しいにゃ！もういいにゃ！" },
    { text: "同時にいろんなものが気になる。箱にも行くし、ヒモも見るし、人にも絡むしで、一つに集中するより全部触りたい動きになる。", quote: "これもにゃ！あれもにゃ！" },
  ],
  "いたずら天才ねこ": [
    { text: "テーブルの端にある物を、わざと少しずつ前足で押す。一回落として終わりじゃなく、こちらの反応を見てもう一回やる。", quote: "どうなるにゃ？もう一回やるにゃ。" },
    { text: "入っちゃダメな場所ほど行きたがる。見られているタイミングを選んでわざと乗るあたり、かなり確信犯っぽい。", quote: "それダメにゃ？試すにゃ。" },
    { text: "他の猫や人にちょっかいを出して反応を見る。逃げたら追いかけるし、反応が大きいほど楽しそうになる。", quote: "いま行くにゃ。遊ぶにゃ。" },
    { text: "普通のおもちゃを独自ルールで使い始める。本来の遊び方より、自分で新しい遊び方を作る方が面白いタイプ。", quote: "これ違うにゃ。こうするにゃ。" },
  ],
  "しきり屋リーダーねこ": [
    { text: "他の猫が落ち着かない動きをしていると、近くまで行って止めに入る。自分のペースに周りを合わせようとする感じが強い。", quote: "順番にゃ。こっち来るにゃ。" },
    { text: "寝る場所や座る場所を先に決めてしまう。あとから来た相手がいても譲らず、その場のルールを自分で作っている。", quote: "ここ使うにゃ。決めるにゃ。" },
    { text: "騒がしいとすぐ様子を見に行く。ただ混ざるというより、何が起きてるか確認して収めに入る動きになる。", quote: "それやめるにゃ。落ち着くにゃ。" },
    { text: "人の動線や部屋の流れをよく見ていて、邪魔な物や乱れた空気があるとそこに自分から入って整えにいく。", quote: "これで行くにゃ。まとめるにゃ。" },
  ],
  "みんな大好きねこ": [
    { text: "来客があると一番最初に玄関の近くまで見に行く。少し様子を見たあと、平気な相手だと分かるとそのまま距離を詰めていく。", quote: "そっちいくにゃ。そこ座るにゃ。" },
    { text: "部屋にいる人全員に順番に甘える。一人のところに少し寄って、また別の人のところに行って、全員にちゃんと絡む。", quote: "こっちもにゃ。そっちも行くにゃ。" },
    { text: "優しそうな人を見つけるのが早い。その人の近くを行ったり来たりして、触ってもらえるまで自然に距離を詰めていく。", quote: "そこいいにゃ。ちょっと寄るにゃ。" },
    { text: "誰かが帰ろうとすると後ろをついていく。ドアの前まで見送りに来て、まだ行くの？みたいな顔で立ち止まる。", quote: "まだ行くにゃ。ついてくにゃ。" },
  ],
  "導きカリスマねこ": [
    { text: "元気がなさそうな人がいると、その人の近くにだけ座る。他の人には行かないのに、その時だけはピンポイントで寄り添う。", quote: "ここにいるにゃ。大丈夫にゃ。" },
    { text: "にぎやかな空気の中でも、場の変化にすぐ気づく。誰かが静かになったり空気が落ちた瞬間に、自然とその方向へ動いていく。", quote: "いま行くにゃ。見てるにゃ。" },
    { text: "複数人いると、順番に顔を見て回る。誰が何してるか全部分かっているみたいな動きで、その場全体を把握している感じがある。", quote: "そっちもにゃ。ちゃんと見るにゃ。" },
    { text: "誰かが移動すると後ろからついていく。でも前に出るわけじゃなく、少し後ろを歩いて見守るような距離感を取る。", quote: "ついてくにゃ。そのままでいいにゃ。" },
  ],
  "覇王ボスねこ": [
    { text: "人が座っていたクッションや椅子を、当然みたいな顔で取りにいく。少しどかされてもまた戻ってきて、最終的にその場所を自分のものにする。", quote: "そこ使うにゃ。もう決まってるにゃ。" },
    { text: "部屋の中で一番高い場所や見渡せる場所を選ぶ。そこに座るとしばらく動かず、全体を見ている感じになる。", quote: "ここが上にゃ。ここにいるにゃ。" },
    { text: "歩き出すと他の猫や人が自然に道をあける。急いでいなくても、自分が通る前提でまっすぐ進んでくる。", quote: "通るにゃ。あけるにゃ。" },
    { text: "人が集まると、その中央か一番目立つ位置を取る。誰より先にいい場所を押さえて、最後までそこを譲らない。", quote: "ここにするにゃ。動かないにゃ。" },
  ],
};

function getRandomAruaru(type: CatType): AruaruSet {
  const list = aruaruMap[type];
  return list[Math.floor(Math.random() * list.length)];
}
...
export default function Home() {
  ...
  const selectedAruaru = useMemo(() => {
    if (!result) return null;
    return getRandomAruaru(result.mainType);
  }, [result]);
          ...
          {!showResult && !isCalculating ? (
            ...
            <>
              ...
              <div className="rounded-3xl bg-white p-5 ring-1 ring-[#f2e5dc] sm:p-6">
                ...
                >
                  <p className="mb-2 text-center text-sm">うちの子は…</p>

                  <div className="mb-1 text-center text-5xl">{resultMeta[result.mainType].emoji}</div>

                  <h3 className="mb-2 text-center text-xl font-bold sm:text-2xl">{result.mainType}</h3>

                  <div className="mb-2 space-y-0 leading-tight text-left">
                  ...
                  <div className="mb-2 text-left">
                    <p className="mb-1 font-bold">あるある</p>
                    <p className="leading-tight text-[#4e433d]">
                      {selectedAruaru?.text}
                    </p>
                  </div>

                  <p className="mb-2 text-left font-bold not-italic">
                    🐾 {selectedAruaru?.quote}
                  </p>

                  <div className="mb-2 text-center">
                    <p className="text-xs">相性BEST</p>
                    <p className="font-semibold">{bestMatchMap[result.mainType]} ★★★★★</p>
                  </div>

                  <p className="text-center text-[10px] text-gray-500">#ねこびーてぃあい</p>
                </div>
